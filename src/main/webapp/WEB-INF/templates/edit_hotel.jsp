...
<div class="container-fluid">
    ...
    <div class="row m-2">
        <h1 class="text-center">Изменить ${hotel.name} отель</h1>
    </div>

    <div class="row">
        <form:form action="${pageContext.request.contextPath}/hotels/edit" method="post" modelAttribute="hotel">
            <form:hidden path="id" />
            ...
            <div class="mb-3">
                <label for="hotelDescription" class="form-label">Описание отеля</label>
                <form:textarea path="description" class="form-control" id="hotelDescription" rows="3"></form:textarea>
            </div>

            <div class="mb-3">
                <label for="hotelCountry" class="form-label">Страна отеля</label>
            ...
            <div class="mb-3">
                <button class="btn btn-success" type="submit">Подтвердить изменение</button>
            </div>
